...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] flex items-center justify-center px-4 transition-colors duration-300 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Sign in to your Eventix account</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-xl shadow-slate-200/50 dark:shadow-none transition-colors duration-300">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {errors.password && (
                <p className="text-red-500 dark:text-red-400 text-xs mt-1.5 font-medium">{errors.password}</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-400 disabled:bg-indigo-400 dark:disabled:bg-indigo-500/50 text-white font-bold rounded-xl transition-all shadow-lg shadow-indigo-500/30 dark:shadow-none text-sm mt-4 flex items-center justify-center"
            >
              {loading ? (
        ...
        <p className="text-center text-slate-500 dark:text-slate-500 text-xs mt-6 font-medium">
          New here? Register an account to get started.
        </p>
      </motion.div>
    </div>
  );
